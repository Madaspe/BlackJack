...
def lost():
    screen.fill((0, 128, 0))
    label = myfont.render('Нажмите кнопку для игры', 1, (255, 255, 255))
    label2 = myfont.render('Фишки кончились', 1, (255, 255, 255))
...
def bet():
    global betChips
    global playerChips
    label = myfont.render('Сделайте вашу ставку ', 1, (255, 255, 255))
    screen.blit(label, (230, 430))
    updateChips()
    pygame.display.update()
    while True:
        label = smallFont.render('Нажми пробел', 1, (255, 255, 255))
...
def firstStart():
    ...
    playerChips = 50
    screen.fill((0, 128, 0))
    label = myfont.render('Играем в  Black Jack!', 1, (255, 255, 255))
    label2 = myfont.render('Пробел для начала', 1, (255, 255, 255))
...
def updateChips():
    ...
    label = smallFont.render('Фишки' + str(playerChips), 1, (255, 255, 255))
...
def main():
    ...
    while True:
        ...
        if playerReveal == False:
            ...
            label = smallFont.render('продолжить пробел', 1, (255, 255, 255))
            screen.blit(label, (430, 850))
            ev = pygame.event.poll()
            if ev.type == pygame.QUIT:
                pygame.quit()
            ...
            label = smallFont.render('Пробел взять, таб не брать', 1, (255, 255, 255))
            ...
            if p.getScore() > 21:
                label = myfont.render('Больше 21', 1, (255, 255, 255))
